  ...
  return (
    <Box p={4} >
      ...
      <Paper variant="outlined" sx={{ p: 3, mb: 4 }}>
        ...
        <Grid container spacing={1} direction={"column"}> {/* This is the main container for all fields */}
          {/* 주문자 */}
          <Grid item xs={12} container alignItems="center" spacing={1}>
            <Grid item xs={12} sm={3}  sx={{width:"13%", textAlign:"right"}}>
              <Typography variant="subtitle1">주문자 :</Typography>
            </Grid>
            <Grid item xs={12} sm={9}>
              <TextField fullWidth defaultValue="홍길동" size="small" sx={{width:"60%"}}/>
            </Grid>
          </Grid>
          ...
          <Grid item xs={12} container alignItems="center" spacing={1}>
            <Grid item xs={12} sm={3} sx={{width:"13%", textAlign:"right"}}>
              <Typography variant="subtitle1">물품 출발 주소 :</Typography>
            </Grid>
            <Grid item xs={9} sm={7} sx={{width:"30%"}}>
              <TextField fullWidth label="물품 출발 주소" size="small"  />
            </Grid>
            <Grid item xs={3} sm={2}>
          ...
          <Grid item xs={12} container alignItems="center" spacing={1}>
            <Grid item xs={12} sm={3} sx={{width:"13%", textAlign:"right"}}>
              <Typography variant="subtitle1">상세 주소 입력 :</Typography>
            </Grid>
            <Grid item xs={12} sm={9} sx={{width:"50%"}}>
              <TextField fullWidth label="상세 주소 입력" size="small" />
            </Grid>
          </Grid>
          ...
          <Grid item xs={12} container alignItems="center" spacing={1}>
            <Grid item xs={12} sm={3} sx={{width:"13%", textAlign:"right"}}>
              <Typography variant="subtitle1">휴대전화 :</Typography>
            </Grid>
            <Grid item xs={3} sm={2} sx={{width:"10%"}}>
              <TextField fullWidth label="010" size="small" />
            </Grid>
            <Grid item xs={1} sm={1} sx={{width:"3%"}}>
              <Typography align="center"> - </Typography>
            </Grid>
            <Grid item xs={3} sm={2} sx={{width:"10%"}}>
              <TextField label="1234" size="small"  />
            </Grid>
            <Grid item xs={1} sm={1} sx={{width:"3%"}}>
              <Typography align="center"> - </Typography>
            </Grid>
            <Grid item xs={3} sm={2} sx={{width:"10%"}}>
              <TextField fullWidth label="5678" size="small" />
            </Grid>
          </Grid>
          ...
          <Grid item xs={12} container alignItems="center" spacing={1}>
            ...
            <Grid item xs={4} sm={3} sx={{width:"18%"}}>
              <TextField fullWidth defaultValue="abcd1234" size="small" />
            </Grid>
            <Grid item xs={1} sm={1}>
              <Typography align="center">@</Typography>
            </Grid>
            <Grid item xs={4} sm={3}>
              <TextField fullWidth defaultValue="naver.com" size="small" />
            </Grid>
            <Grid item xs={3} sm={2}>
